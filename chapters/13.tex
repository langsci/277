...
Third, there are languages such as \ili{Turkish} where both \eqref{ex:13.19} and
\REF{ex:13.20} are set positively, [Yes \gls{CDAP}, Yes \gls{DAP}]. As a result, the
...
\ea%28
\label{ex:13.28}\ili{Greek} (AAIM 2012: (36))\\
...
\ea%29
    \label{ex:13.29}\ili{Greek} (AAIM 2012: (41), (63))\\
...
\REF{ex:13.40}, the in situ DP subject obligatorily agrees with both the
...
follows from \eqref{ex:13.37} above.  Nevertheless, agreement can never
