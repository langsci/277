...
similar to the languages discussed in~\Cref{sec:key:13.2}, we have two verbs
...
case} is unmarked, then this means that \ili{Greek} is a \gls{CDAP}:no language
...
trace genitive\is{genitive case} DP \glspl{IO} or PPs but only \Nom{} DPs.
