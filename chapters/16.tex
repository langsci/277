...
As can be seen in (\ref{ex:key:16.6}a,b), the pronoun in the
\gls{APC}\is{adnominal pronoun construction} overtly shows the case assigned to
the DP; nominative\is{nominative case} in (\ref{ex:key:16.6}a), accusative in
(\ref{ex:key:16.6}b).\footnote{The following is an expression in a Facebook
...
the nominative--accusative distinction is visible only on pronouns.
...
pronouns if we take the clitic \emph{–s} in (\ref{ex:key:16.7}b) to be a
...
(\ref{ex:key:16.8}a) is virtually unparsable. (\ref{ex:key:16.8}b) may be
somewhat marginal but is very clearly preferable to (\ref{ex:key:16.8}a),
...
they prefer. Another clearly well-formed alternative is (\ref{ex:key:16.8}c),
