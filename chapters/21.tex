...
\citep{Chomsky2000}. So, \REF{ex:21.5} should be refines as follows:
...
(\ref{ex:21.14}a--b) must be attracted, but its head, the complementizer\is{complementizers}, has
