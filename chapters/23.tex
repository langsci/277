...
\eqref{ex:key:23.2}/\eqref{ex:key:23.3} if implicit control\is{control!implicit
...
passive\is{passive} contexts such as \eqref{ex:key:23.2}/\eqref{ex:key:23.3};
in the specific examples above, it would be excluded due to the resulting
\isi{binding} violation between PRO and the embedded pronouns).
