...
\begin{figure}
    ...
    \end{tikzpicture}}
    {\caption{{\color{red}Please provide a caption}\label{fig:ex:23.5}}}%
    \ffigbox[.5\textwidth]
    ...
    \end{tikzpicture}}
    {\caption{\color{red}Please provide a caption\label{fig:ex:23.6}}}
\end{floatrow}
\end{figure}

A possible account of \eqref{ex:23.4} (this is a modified version of van Urk’s suggestion)\largerpage[2]\relax
is illustrated in \figref{fig:ex:23.5}. I assume that implicit passive\is{passive} arguments are
...
dependency with T, for instance, via a D-feature in T as indicated in \eqref{ex:23.4}, or
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{\color{red}Please insert subcaption}
    \end{subfigure}%
    \begin{subfigure}[b]{.5\linewidth}
    \begin{tikzpicture}[baseline=(root.base)]
