...
though, \Cref{sec:key:18.8}.} This is shown by (\ref{ex:key:18.8}a), where we
...
intensifier\is{intensifiers} and a downtoning one. As \REF{ex:key:18.15} shows,
...
participles in \REF{ex:key:18.26} is adjectival (see also
...
properties.  The present participles in \REF{ex:key:18.24} express durative
...
participles in \REF{ex:key:18.25} express perfective aspect: we are dealing
...
Secondly, as shown in \REF{ex:key:18.28}, these participles can be prefixed by
...
attributive AP, as depicted in \REF{ex:key:18.36}.
...
\emph{heel}, as is exemplified in \REF{ex:key:18.43}:
