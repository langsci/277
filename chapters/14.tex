...
\begin{figure}
\small
\caption{\color{red}Please insert a caption. Maybe also say that dashed lines symbolise valuations, solid lines transfers.\label{fig:ex:14.15}}
...
\ref{ex:14.4}--\ref{ex:14.5}) show that \gls{BP}\il{Brazilian Portuguese} allows for
...
determined by φ-feature\is{φ-features} requirements), as well as in BP, as in \eqref{ex:14.38}
...
clitic pronoun \emph{te} is either accusative or dative\is{dative case}.\largerpage[1]
