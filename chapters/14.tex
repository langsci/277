...
As we saw above (cf.\ examples in \eqref{ex:14.6}), subject--verb agreement is
...
\eqref{ex:14.4}--\eqref{ex:14.5}) show that \gls{BP}\il{Brazilian Portuguese}
allows for movement from the subject position of a tensed clause to another
subject position (see \citealt{NunesMartins2010}). Such a \isi{movement}
