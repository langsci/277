...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Clitics}\label{sec:16.1}
...
\section{Noun incorporation}\label{sec:16.2}\glsunset{NI}\largerpage
...
both cases; see \Cref{sec:16.2.4}): \emph{n} in Type Ia, and D$^i$
in Type IV.\is{adjunction}

\ea  {}[\tss{\emph{v}P} \emph{v}\tss{\{[+V], \Acc{}, \ldots{}\}} [\tss{VP}
[\tss{V} [ \hspace{-.7ex}\emph{n}\tss{\{[+N]\}}] [ \hspace{-.7ex}V]]]]\label{13}
\z
Both Type Ia and Type IV \isi{noun incorporation} are characterised by the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{On doubling}\label{sec:16.3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Object pro-drop and defective goals}\label{sec:16.4}
...
VP-internal object guarantees the latter's silence.\footnote{A reviewer asks
    ...
    need to be antipassivised in order for a non-specific \enquote{object} to
