...
\begin{subfigure}[b]{.5\textwidth}\centering
    ...
    \end{tikzpicture}
    \caption{\color{red}Please enter caption for this subfigure\label{fig:fromex:10.15a}}
    ...
    \end{tikzpicture}
    \caption{\color{red}Please enter caption for this subfigure\label{fig:fromex:10.15b}}
    \end{subfigure}
    \caption{\color{red}Please enter caption for the parent figure}
\end{figure}
