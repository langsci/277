...
DOM\is{differential object marking} in \ili{Romanian}, while it might do so in
\ili{Spanish} more frequently. For example, as shown by
...
always be 3rd person\is{person features}, and thus would plausibly be left
...
\tabref{tab:key:27.2} summarizes my proposal:\footnote{A reviewer asks why 3rd
    ...
    feasible to have 1st/2nd person\is{person features} as [$+$participant,
    +person], and animate third person\is{person features} as [$+$person].  I
    think the problem with that is that there would be a redundancy for 1st and
    2nd person\is{person features}, since participants are necessarily
    [$+$person]. In my system it is clearer that the 3rd person\is{person
features} is the \enquote{non-person}, as son many times it has been suggested
