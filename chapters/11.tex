...
\ea%5
    ...
    \gll Juma    a-li-(ki)-soma  ki-tabu\\
        Juma\eqref{ex:11.1}  1-\Pst-7-read    7-book\\
...
S\textsuperscript{T}, once more suggesting \isi{ergativity} (see \eqref{ex:11.7} vs. \eqref{ex:11.8}).
...
(as shown in \eqref{ex:11.4}). Subjective being in the accusative family
...
discussed below (see \eqref{ex:11.24}).} This has the effect that
