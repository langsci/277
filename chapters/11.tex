...
If so, the language is complete for γ and in fact tripartite (\ref{ex:11.12}e,
e.g.\ \ili{Paumarí} for case), but if not, the language is incomplete for γ,
and in fact subjective (\ref{ex:11.13}a, e.g.\ \ili{Paumarí} for agreement).
