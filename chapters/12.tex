...
\gls{DOM}\is{differential object marking} distinction
...
a definite or specific reading, whereas in~(\ref{ex:key:12.1}a) it has a partitive\is{partitive case} or
nonspecific indefinite reading. The bare object in~(\ref{ex:key:12.2}b), however, is very close
in meaning to the partitive\is{partitive case} objects in (1a,b); it also has what is broadly
speaking a nonspecific indefinite meaning.\footnote{An anonymous reviewer asks
    ...
    pragmatically from a partitive\is{partitive case} object like the one in~(\ref{ex:key:12.1}a), given that both
    ...
    consistent difference.  One possible hint is that~(\ref{ex:key:12.1}a) with \isi{partitive case}
...
in explicit partitive\is{partitive case} constructions like~(\ref{ex:key:12.3}a), and since some examples with
partitive case do not naturally have a partitive\is{partitive case} translation (e.g.,~(\ref{ex:key:12.1}b)).
However, this is the term now used in \ili{Sakha} grammar studies, and the case does
express partitive\is{partitive case} meanings in some examples (e.g.,~(\ref{ex:key:12.1}a)); it also does have
...
transitive verb in \ili{Sakha} can bear \isi{partitive case} if the conditions are met: if
the clause is imperative\is{imperatives}, and the object permits a nonspecific indefinite
reading.  In this sense, \isi{partitive case} is no less a structural case than overt
accusative or bare accusative\is{accusative case} is. The use of this case is limited
...
accusative case on the object in~(\ref{ex:key:12.2}a) and \isi{partitive case}
...
special features, the object can still be partitive\is{partitive case}.~(\ref{ex:key:12.4}a) shows
this with an overt NP serving as the addressee, as is possible in all varieties
of \ili{English};~(\ref{ex:key:12.4}b) shows it with a kind of third person
...
The examples in~\eqref{ex:key:12.10} also show that having \isi{partitive case}
...
contrast with unergative\is{unergativity} subjects ((5)). In fact, this is
impossible in \ili{Sakha}, as shown in~\eqref{ex:key:12.12}.
...
the fact that the imperative\is{imperatives} operator in an example like~\eqref{ex:key:12.6} necessarily has
...
future tense imperative\is{imperatives} seen in~\eqref{ex:key:12.13}; here imperative\is{imperatives} has scope over the future
tense.
...
from the addressee; this is what we find in examples like~(\ref{ex:key:12.4}b) in \ili{Sakha}.
...
Possible independent evidence that \isi{imperatives} in \ili{Sakha} involve a special v
...
used in the imperative\is{imperatives}; hence~\eqref{ex:key:12.16} is ungrammatical.\newpage
...
nonfinite control-like\is{control} complements, as shown in~\eqref{ex:key:12.18}.\newpage
...
\z
Some speakers even allow Jussive in the matrix clause to license \emph{v}\textsubscript{\Imp} inside a fully finite complement clause, permitting \isi{partitive case} on the object of the embedded clause as in~\eqref{ex:key:12.19}, whereas for other speakers this is ruled out.
...
\z
In contrast, nobody allows a matrix imperative\is{imperatives} to license \isi{partitive case} on the subject of an embedded clause in a sentence like~\eqref{ex:key:12.20}.
...
out.~(\ref{ex:key:12.21}b) is the structure of an imperative\is{imperatives} with a definite
...
does have the resources to handle \isi{partitive case} in Sakha—both the fact
...
one very specific type of clause. Partitive case in \ili{Sakha} can thus be
