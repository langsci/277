...
\ea%44
    ...
    \ex cf.\ Japanese\\
    \gll    $\varnothing$\tss{\Genc} kutsu-de haite-wa ikenai.\\
            {} shoe-with enter-\Topic{} cannot\\
    \ex cf.\ English\\
    \textbf{Você} / \textbf{a gente} nao pode entrar de sapato.\\
        ‘You / one can’t get in with your / one’s shoes on.’
    \z
\z
...
gente}), a possibility nonexistent in \ili{Icelandic}, except in c., where we
have a null expletive\is{expletives}:
