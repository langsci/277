...
\ea%12
    \label{ex:key:26.12}
    \ea \ili{French} (apud \citealt{Roberts1993})
    \sn
...
\ea%36
    ...
    \sn Aqui conserta sapato.
    \ex\ili{Japanese}
    \sn Koko-de-\textbf{wa}  kutsu-o nao-su.\\
...
\ea%49
    ...
    \sn {}[ O pai\tss{i} do João\tss{k} ]\tss{i} disse que
            $\varnothing$\tss{i/*k/j} era estúpido
\z
...
while in \ili{Finnish} they seem to be in SpecFP, an Aʹ-position;
