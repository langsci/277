...
\eqref{ex:26.25} below as a matter of acquisition\is{language acquisition}, in
line with what we saw in \Cref{sec:26.2.3}.  According to these authors,
children start with the parameter in \gls{BP}\il{Brazilian Portuguese} set as
