...
to define because the languages under this label may show a range of
...
some authors.\footnote{For some reason to be investigated, the most popular
    authors of this type of “light” plays written in Rio de Janeiro made an
    option in favor of \emph{você}. The city population has not abandoned the
...
frequent in daily speech (cf.\ (c)).\footnote{See \citet{Britto2000}, for whom
